...
const USE_CASE_NAME = "WiFi Enabled CCTV Cameras";
...
const CCTVDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        console.error("CCTVDashboard fetch failed:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const palette = [
    { borderColor: "#64748b", icon: Camera },
    { borderColor: "#0ea5e9", icon: Wifi },
    { borderColor: "#10b981", icon: Eye },
    { borderColor: "#f59e0b", icon: Bell },
    { borderColor: "#8b5cf6", icon: ShieldCheck },
    { borderColor: "#f97316", icon: Camera },
  ];
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-7xl">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 gap-3 text-muted-foreground">
            ...
            <p className="text-sm">Loading CCTV data…</p>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Summary card */}
              <Card className="border-0 shadow-sm bg-gradient-to-br from-slate-50 to-gray-50 dark:from-slate-900/20 dark:to-gray-900/20">
                    ...
                    {[
                      {
                        ...
                        desc: "High-definition cameras covering key village locations 24/7",
                      },
                      {
                        icon: Wifi,
                        color: "#0ea5e9",
                        title: "WiFi Connectivity",
                        desc: "Wireless network-connected cameras eliminating cable infrastructure",
                      },
                      {
                        icon: Eye,
                        color: "#10b981",
                        title: "Live Monitoring",
                        desc: "Real-time video feeds accessible remotely via secure portal",
                      },
                      {
                        icon: Bell,
                        color: "#f59e0b",
                        title: "Motion Alerts",
                        desc: "Instant alerts triggered on motion detection for rapid response",
                      },
