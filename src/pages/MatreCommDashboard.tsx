...
const MatreCommDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        console.error("MatreCommDashboard fetch failed:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const palette = [
    { borderColor: "#0ea5e9", icon: Network },
    { borderColor: "#8b5cf6", icon: Signal },
    { borderColor: "#10b981", icon: Wifi },
    { borderColor: "#f59e0b", icon: Radio },
    { borderColor: "#6366f1", icon: ShieldCheck },
    { borderColor: "#f97316", icon: Network },
  ];
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-7xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-2.5 bg-muted/60 border border-border rounded-xl px-4 py-2.5 self-start">
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-foreground">MatreComm</p>
            </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 gap-3 text-muted-foreground">
            ...
            <p className="text-sm">Loading CraftWANI data…</p>
          </div>
        ) : (
          <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              {/* Summary card */}
              <Card className="border-0 shadow-sm bg-gradient-to-br from-sky-50 to-blue-50 dark:from-sky-900/20 dark:to-blue-900/20">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-sky-700 dark:text-sky-300 flex items-center gap-2">
                    <Network className="h-4 w-4" style={{ color: "#0ea5e9" }} />
                    System Summary
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-0">
                  {[
                    ...
                    <div
                      key={label}
                      className="flex items-center gap-3 py-3 border-b border-sky-100 dark:border-sky-800 last:border-0"
                    >
              ...
              <Card className="border-0 shadow-sm lg:col-span-2">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold flex items-center gap-2">
                    <Signal className="h-4 w-4" style={{ color: "#8b5cf6" }} />
                    System Capabilities
                  </CardTitle>
                </CardHeader>
                <CardContent>
                    ...
                    {[
                      {
                        ...
                        color: "#0ea5e9",
                        title: "Rural WAN",
                        desc: "Extends broadband connectivity to underserved rural areas via CraftWANI technology",
                      },
                      {
                        icon: Signal,
                        color: "#8b5cf6",
                        title: "Signal Coverage",
                        desc: "Wide-area signal distribution ensuring last-mile connectivity for all residents",
                      },
                      {
                        icon: Wifi,
                        color: "#10b981",
                        title: "High Availability",
                        desc: "Redundant network paths ensure continuous uptime for critical services",
                      },
                      {
                        icon: Radio,
                        color: "#f59e0b",
                        title: "Backhaul Links",
                        desc: "Microwave and radio backhaul links connecting remote nodes to the core network",
                      },
...
export default MatreCommDashboard;
