...
const USE_CASE_NAME = "Smart Intelligent Village - Central NOC";
...
const CentralNOCDashboard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        console.error("CentralNOCDashboard fetch failed:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const palette = [
    ...
    { borderColor: "#10b981", icon: Monitor },
    { borderColor: "#8b5cf6", icon: Radio },
    { borderColor: "#6366f1", icon: ShieldCheck },
    { borderColor: "#f59e0b", icon: Activity },
  ];
      ...
      <div className="container mx-auto px-4 pt-24 pb-16 max-w-7xl">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-32 gap-3 text-muted-foreground">
            ...
            <p className="text-sm">Loading NOC data…</p>
          </div>
        ) : (
          <>
              ...
              <Card className="border-0 shadow-sm bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-900/20 dark:to-amber-900/20">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-orange-700 dark:text-orange-300 flex items-center gap-2">
                    <Radio className="h-4 w-4" style={{ color: "#f97316" }} />
                    System Summary
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-0">
                  {[
                    ...
                    <div
                      key={label}
                      className="flex items-center gap-3 py-3 border-b border-orange-100 dark:border-orange-800 last:border-0"
                    >
                      <Icon
                    ...
                    {[
                      {
                        ...
                        desc: "Single dashboard visibility across all smart village use cases and sensors",
                      },
                      {
                        icon: Activity,
                        color: "#0ea5e9",
                        title: "Real-time Alerts",
                        desc: "Instant notifications for anomalies and critical events across the village",
                      },
                      {
                        icon: Network,
                        color: "#10b981",
                        title: "System Integration",
                        desc: "Connects and orchestrates all IoT systems deployed in Satnavari village",
                      },
                      {
                        icon: Radio,
                        color: "#8b5cf6",
                        title: "Remote Management",
                        desc: "Remotely configure, update, and manage deployed devices from a central console",
                      },
...
export default CentralNOCDashboard;
